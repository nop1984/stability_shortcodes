 ...
 * @Shortcode(
 *   id = "featured_boxes",
 *   title = @Translation("Featured Box Container"),
 *   description = @Translation("Animated on mouse hover event boxes with icon and text.")
 * )
 */
class FeaturedBoxes extends ShortcodeBaseEx {
