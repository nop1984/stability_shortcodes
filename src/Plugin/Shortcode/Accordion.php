 ...
 *   description = @Translation("Insert a Accordion.")
 * )
 */
class Accordion extends ShortcodeBaseEx {

  protected $class = "panel panel-default";
  ...
  public function getThemeVars($with_hash = false, $merge = []) {
	   ...
	   */
	  $res = parent::getThemeVars($with_hash, array_merge(['active'=>null], $merge));
	  return $res;
  }
}